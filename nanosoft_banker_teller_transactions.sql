...
--
-- Table structure for table `teller_transactions`
--
...
CREATE TABLE `teller_transactions` (
  ...
  `sDesciption` varchar(100) DEFAULT NULL,
  `TransactionType` varchar(20) DEFAULT NULL,
  `AccountType` varchar(2) DEFAULT '-',
  PRIMARY KEY (`id`),
  KEY `FK_teller_transactions_userID` (`TellerID`),
  CONSTRAINT `FK_teller_transactions_userID` FOREIGN KEY (`TellerID`) REFERENCES `systemusers` (`UserID`) ON UPDATE CASCADE
