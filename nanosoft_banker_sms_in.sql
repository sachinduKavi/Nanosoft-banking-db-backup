...
CREATE TABLE `sms_in` (
  ...
  `sms` varchar(150) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FK_sms_in_cus_id` (`CustomerID`),
  CONSTRAINT `FK_sms_in_cus_id` FOREIGN KEY (`CustomerID`) REFERENCES `customerinformation` (`CustomerID`) ON UPDATE CASCADE
